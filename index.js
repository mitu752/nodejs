...
const UUID = process.env.UUID || '7ecba764-ab92-4842-9313-84bdd2a1fcc5'; // 使用哪吒v1部署多个需要修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'site--asdf--4yyjgl8d67jf.code.run';  // 必填,改为自己的app名称和账户名：app名称-账户名称.ladeapp.com
